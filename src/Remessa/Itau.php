...
class Itau extends Remessa {
	...
	public function setHeader(){
		...
		$conteudo .= 341;            							//codigo banco            N� BANCO C�MARA COMP. 077 079        9(03)
	...
	public function setMovimento(){
		...
		foreach($this->titulos as $cliente)
		{
			...
			$conteudo .= $this->formatNumber($cliente->id_titulo,25);               // USO / IDENT. DO T�TULO NA EMPRESA NOTA 2            		038 062        X(25)
			...
			$conteudo .= $this->formatNumber($config->carteira,3);                  // n� da carteira        n� carteira banco                	084 086        9(03)            
